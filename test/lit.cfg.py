...
config.mx_libs_dir = os.path.join(config.mx_obj_root, "lib")

config.substitutions.append(("%mx_libs", config.mx_libs_dir))
...
python_path = [os.path.join(config.mlir_obj_dir, "python_packages", "mx")]
